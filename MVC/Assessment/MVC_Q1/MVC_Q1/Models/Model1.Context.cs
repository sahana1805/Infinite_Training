...
namespace MVC_Q1.Models
{
    ...
    public partial class NorthwindEntities : DbContext
    {
        ...
        [DbFunction("NorthwindEntities", "LookByFName")]
        public virtual IQueryable<LookByFName_Result> LookByFName(string firstLetter)
        {
            var firstLetterParameter = firstLetter != null ?
                new ObjectParameter("FirstLetter", firstLetter) :
                new ObjectParameter("FirstLetter", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<LookByFName_Result>("[NorthwindEntities].[LookByFName](@FirstLetter)", firstLetterParameter);
        }
        ...
        public virtual ObjectResult<sp_Employees_Cursor_Result> sp_Employees_Cursor(string cityIn)
        {
            var cityInParameter = cityIn != null ?
                new ObjectParameter("CityIn", cityIn) :
                new ObjectParameter("CityIn", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<sp_Employees_Cursor_Result>("sp_Employees_Cursor", cityInParameter);
        }
        ...
        public virtual ObjectResult<sp_employees_rank_Result> sp_employees_rank()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<sp_employees_rank_Result>("sp_employees_rank");
        }
    
        public virtual ObjectResult<sp_employees_rollup_Result> sp_employees_rollup()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<sp_employees_rollup_Result>("sp_employees_rollup");
        }
    
        public virtual ObjectResult<sp_employees_rownum_Result> sp_employees_rownum()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<sp_employees_rownum_Result>("sp_employees_rownum");
        }
    
        public virtual ObjectResult<sp_Employees_SelectAll_Result> sp_Employees_SelectAll()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<sp_Employees_SelectAll_Result>("sp_Employees_SelectAll");
        }
    
        public virtual ObjectResult<sp_Employees_SelectRow_Result> sp_Employees_SelectRow(Nullable<int> employeeID)
        {
            var employeeIDParameter = employeeID.HasValue ?
                new ObjectParameter("EmployeeID", employeeID) :
                new ObjectParameter("EmployeeID", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<sp_Employees_SelectRow_Result>("sp_Employees_SelectRow", employeeIDParameter);
        }
